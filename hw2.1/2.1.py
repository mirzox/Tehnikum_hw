...
while True:
    ...
    if agree == 'да':
            ...
            while True:
                try:
                    ...
                    if req == 'да':
                        ...
                        print("Вам будет предоставлен бонус если вы отправите ваш номер телефона, а про бонус узнаете когда отправите номер телефона🙃🙃🙃")
                    else:
                        print("Не верный ввод попробуйте заново!!!")
                    if isready(name,'phone'):
                        print('''Ваш бонус это бесплатная подписка на бот Махмуд ака v2.0😂😂😂
        ...
        print("Жаль на придется прошатся 😥😥😥")
        time.sleep(2)
        os.system('cls')
